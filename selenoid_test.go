...
func TestNewSessionWithGet(t *testing.T) {
	t.Run("GET /wd/hub/session returns 405 Method Not Allowed", func(t *testing.T) {
...
func TestBadJsonFormat(t *testing.T) {
	t.Run("POST /wd/hub/session rejects malformed JSON body", func(t *testing.T) {
...
func TestGetDefaultScreenResolution(t *testing.T) {
	t.Run("Get default screen resolution", func(t *testing.T) {
...
func TestGetFullScreenResolution(t *testing.T) {
	t.Run("Get full screen resolution", func(t *testing.T) {
...
func TestGetShortScreenResolution(t *testing.T) {
	t.Run("Get short screen resolution", func(t *testing.T) {
...
func TestTooBigSessionTimeoutCapability(t *testing.T) {
	t.Run("Too big session timeout capability", func(t *testing.T) {
		testBadSessionTimeoutCapability(t, "1h1m")
	})
}

func TestInvalidSessionTimeoutCapability(t *testing.T) {
	t.Run("Invalid session timeout capability", func(t *testing.T) {
...
func TestMalformedScreenResolutionCapability(t *testing.T) {
	t.Run("Malformed screen resolution capability", func(t *testing.T) {
		manager = &BrowserNotFound{}
...
func TestGetVideoScreenSizeFromCapability(t *testing.T) {
	t.Run("Get video screen size from capability", func(t *testing.T) {
...
func TestDetermineVideoScreenSizeFromScreenResolution(t *testing.T) {
	t.Run("Determine video screen size from screen resolution", func(t *testing.T) {
...
func TestMalformedVideoScreenSizeCapability(t *testing.T) {
	t.Run("Malformed video screen size capability", func(t *testing.T) {
		manager = &BrowserNotFound{}
...
func TestNewSessionNotFound(t *testing.T) {
	t.Run("New session not found", func(t *testing.T) {
		manager = &HTTPTest{Handler: Selenium()}
...
func TestNewSessionHostDown(t *testing.T) {
	t.Run("New session host down", func(t *testing.T) {
		canceled := false
		ch := make(chan bool)
		manager = &HTTPTest{
			Handler: Selenium(),
...
func TestNewSessionBadHostResponse(t *testing.T) {
	t.Run("New session bad host response", func(t *testing.T) {
		canceled := false
		ch := make(chan bool)
		manager = &HTTPTest{
...
func TestSessionCreatedW3C(t *testing.T) {
	t.Run("Session created w 3 c", func(t *testing.T) {
		manager = &HTTPTest{Handler: Selenium()}
...
func TestSessionCreatedFirstMatchOnly(t *testing.T) {
	t.Run("Session created first match only", func(t *testing.T) {
		manager = &HTTPTest{Handler: Selenium()}
...
func TestSessionCreatedWdHub(t *testing.T) {
	t.Run("Session created wd hub", func(t *testing.T) {
...
func TestSessionWithContentTypeCreatedWdHub(t *testing.T) {
	t.Run("Session with content type created wd hub", func(t *testing.T) {
		root := http.NewServeMux()
		root.Handle("/wd/hub/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			r.URL.Path = strings.TrimPrefix(r.URL.Path, "/wd/hub")
...
func TestSessionCreatedRedirect(t *testing.T) {
	t.Run("Session created redirect", func(t *testing.T) {
...
func TestSessionCreatedRemoveExtensionCapabilities(t *testing.T) {
	t.Run("Session created remove extension capabilities", func(t *testing.T) {
...
func TestProxySessionPanicOnAbortHandler(t *testing.T) {
	t.Run("Proxy session panic on abort handler", func(t *testing.T) {
...
func TestSessionOnClose(t *testing.T) {
	t.Run("Session on close", func(t *testing.T) {
		manager = &HTTPTest{Handler: Selenium()}
...
func TestProxySessionCanceled(t *testing.T) {
	t.Run("Proxy session canceled", func(t *testing.T) {
		canceled := false
		ch := make(chan bool)
		manager = &HTTPTest{
			Handler: Selenium(),
...
func TestNewSessionTimeout(t *testing.T) {
	t.Run("New session timeout", func(t *testing.T) {
		canceled := false
		ch := make(chan bool)
		manager = &HTTPTest{
			Handler: Selenium(),
...
func TestProxySessionTimeout(t *testing.T) {
	t.Run("Proxy session timeout", func(t *testing.T) {
		canceled := false
		ch := make(chan bool)
		manager = &HTTPTest{
			Handler: Selenium(),
...
func TestFileUploadBadJson(t *testing.T) {
	t.Run("File upload bad JSON", func(t *testing.T) {
		manager = &HTTPTest{Handler: Selenium()}
...
func TestFileUploadNoFile(t *testing.T) {
	t.Run("File upload no file", func(t *testing.T) {
		manager = &HTTPTest{Handler: Selenium()}
...
func TestFileUploadTwoFiles(t *testing.T) {
	t.Run("File upload two files", func(t *testing.T) {
		manager = &HTTPTest{Handler: Selenium()}
...
func TestServeAndDeleteVideoFile(t *testing.T) {
	t.Run("Serve and delete video file", func(t *testing.T) {
		fileName := "testfile"
...
func TestServeAndDeleteLogFile(t *testing.T) {
	t.Run("Serve and delete log file", func(t *testing.T) {
...
func TestFileDownloadProtocolExtension(t *testing.T) {
	t.Run("File download protocol extension", func(t *testing.T) {
		testFileDownload(t, func(sessionId string) string {
...
func TestFileDownloadMissingSession(t *testing.T) {
	t.Run("File download missing session", func(t *testing.T) {
...
func TestClipboardProtocolExtension(t *testing.T) {
	t.Run("Clipboard protocol extension", func(t *testing.T) {
		testClipboard(t, func(sessionId string) string {
...
func TestClipboardMissingSession(t *testing.T) {
	t.Run("Clipboard missing session", func(t *testing.T) {
...
func TestAddedSeCdpCapability(t *testing.T) {
	t.Run("session response includes se:cdp and se:cdpVersion capabilities", func(t *testing.T) {
...
func TestParseGgrHost(t *testing.T) {
	t.Run("Parse GGR host", func(t *testing.T) {
...
func TestWelcomeScreen(t *testing.T) {
	t.Run("Welcome screen", func(t *testing.T) {
