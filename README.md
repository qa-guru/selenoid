...
| **Текущий релиз** | **v3.0.9** — [docs/RELEASE_v3.0.9.md](docs/RELEASE_v3.0.9.md) · `qaguru/selenoid:v3.0.9` · **Selenoid 3 hub** (hub-attach Chrome WD) |
| **Selenoid 3** | [selenoid.qa.guru](https://selenoid.qa.guru) — hub **v3.0.9** + UI **v3.0.29** |
