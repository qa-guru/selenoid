...
| **Текущий релиз** | **v3.0.4** — [docs/RELEASE_v3.0.4.md](docs/RELEASE_v3.0.4.md) · `qaguru/selenoid:v3.0.4` · **Selenoid 3 hub** (`harContent`) |
| **Selenoid 3** | [selenoid.qa.guru](https://selenoid.qa.guru) — hub **v3.0.4** + UI **v3.0.13** |
