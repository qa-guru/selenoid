...
|------|----------|
| Линия | Selenoid 3 |
| Stack semver | hub cut **v3.0.15** (prod pin [selenoid.qa.guru](https://selenoid.qa.guru)) |
...
| **Фичи v3+** | native Playwright WS, HAR (`harContent`), warm-pool metrics + Chrome WD container-reuse |
