...
Конфиги: **один SSOT** `dev/browsers.json` (= CI fixture / CM embed / hub config через sync) → PW **1.61.1**, WD chrome default **149.0** (+148), firefox/msedge, все PW engines. Колонки aerokube/Twilio — historical/legacy.
...
| PW 1.60.0 | Chromium | published (prev) | 148.0.7778.96; MCR v1.60.0-noble | — | — | `playwright-chromium:1.60.0` | — |
| PW 1.60.0 | Firefox | published (prev) | 150.0.2 | — | — | `playwright-firefox:1.60.0` | — |
| PW 1.60.0 | WebKit | published (prev) | 26.4 | — | — | `playwright-webkit:1.60.0` | — |
| PW 1.60.0 | Chrome stable | published (prev) | stable channel | — | — | `playwright-chrome:1.60.0` | — |
| PW 1.60.0 | MS Edge | published (prev) | stable channel | — | — | `playwright-msedge:1.60.0` | — |
| PW 1.60.0 | Opera | published (prev) | — | `selenoid/opera:*` legacy | — | — | operadriver 106.0.5249.119 |
| PW 1.60.0 | WebDriver Chrome | published (prev) | CfT 148.0.7778.96 | `selenoid/chrome:148.x` legacy | `chrome_stable_148` legacy | `webdriver-chrome:148` | chromedriver 148.0.7778.178 |
| PW 1.60.0-min | Chromium | published (prev) | 148.0.7778.96 headless | — | — | `playwright-chromium:1.60.0-min` | — |
| PW 1.60.0-min | WebDriver Chrome | published (prev) | CfT 148.0.7778.96 | — | — | `webdriver-chrome:148-min` | — |
...
| PW 1.61.1 | Chromium | active | 149.0.7827.55; MCR v1.61.1-noble | — | — | `playwright-chromium:1.61.1` | — |
| PW 1.61.1 | Firefox | active | 151.0 | — | — | `playwright-firefox:1.61.1` | — |
| PW 1.61.1 | WebKit | active | 26.5 | — | — | `playwright-webkit:1.61.1` | — |
| PW 1.61.1 | Chrome stable | active | stable channel | — | — | `playwright-chrome:1.61.1` | — |
| PW 1.61.1 | MS Edge | active | stable channel | — | — | `playwright-msedge:1.61.1` | — |
...
**Браузер** = столбец в hub: `playwright-chromium` → Chromium, `chrome` → WebDriver Chrome, и т.д. Движки PW — [Microsoft `browsers.json`](https://github.com/microsoft/playwright/blob/main/packages/playwright-core/browsers.json). `chrome:148.0` ≠ `playwright-chromium:1.61.1` (разный протокол).

**docker pull (active):** `qaguru/webdriver-chrome:148` `:148-min` `:149-min` · `qaguru/playwright-chromium:1.61.1` `:1.61.1-min` · `playwright-firefox` / `webkit` / `chrome` / `msedge` `:1.61.1` · `qaguru/video-recorder:latest`.
