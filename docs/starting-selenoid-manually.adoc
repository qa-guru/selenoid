...
All these images are free to use. See image tags for a list of supported versions. Build files are stored in http://github.com/qa-guru/selenoid-images[selenoid-images] repository.
...
. Download binary for your operating system from https://github.com/qa-guru/selenoid/releases/latest[releases] page
