...
Image must be already pulled. https://github.com/qa-guru/cm[Configuration Manager] can help with this task.
...
We recommend to use our https://github.com/qa-guru/cm[configuration tool] to avoid errors with this field.
...
Recent https://github.com/qa-guru/cm[CM] tool versions are able to configure Selenoid from existing `browsers.json` file as follows:
