...
Then run Selenoid like the following:
    ...
    $ DOCKER_API_VERSION=1.45 ./selenoid <rest-of-args> # As a binary
    $ docker run -e DOCKER_API_VERSION=1.45 <rest-of-args> qaguru/selenoid:some-version # As Docker container
