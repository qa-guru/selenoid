...
. Download http://aerokube.com/cm/latest/[Configuration Manager] (Selenoid quick installation binary) for your platform from https://github.com/qa-guru/cm/releases/latest[releases] page.
