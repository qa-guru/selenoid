...
It is using Docker to launch browsers. Please refer to https://github.com/qa-guru/selenoid[qa-guru/selenoid] (fork) or https://github.com/qa-guru/selenoid[aerokube/selenoid] (upstream) for source code.
